/*
Como hemos visto en anteriores sesiones es posible
La entrada de datos a partir de readLine(), que es un metodo
de la consola o la entrada estandar de la computadora;
pero que tal si quiero 
introducioendo, para ello necesito un obj espacial.
...
import java.util.*;  //mandando a llamar toda la librería


class EntradadeDatosUsuario{
